...
then
    ...
    echo "${bldgrn} ${txtrst}"
    echo "${bldgrn}Your UBER-LINARO 6.x.x androideabi Toolchain has completed successfully!!! ${txtrst}"
    ...
    echo "${bldred}**************ERROR***************** ${txtrst}"
    echo " "
    echo "${bldred}Error Log is found at:${txtrst}${red} $DIR/out/UBER-LINARO-ANDROIDEABI-6.x.log ${txtrst}"
    echo " "
